...
pub struct Vertex3f {
    pub pos: Point3f,
    pub tex_coord: Point2f,
}

impl Vertex3f {
    pub fn new(pos: Point3f, tex_coord: Point2f) -> Vertex3f {
        Vertex3f { pos, tex_coord }
    }
    ...
    pub fn attribute_descriptions() -> [vk::VertexInputAttributeDescription; 2] {
        [
            ...
            vk::VertexInputAttributeDescription::builder()
                ...
                .offset(offset_of!(Vertex3f, tex_coord) as u32)
                .build(),
        ]
    }

    pub fn transform(&self, transform: &Transform3f) -> Vertex3f {
        Vertex3f::new(transform * self.pos, self.tex_coord)
    }
}
